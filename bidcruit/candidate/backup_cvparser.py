        ...
        for l,m in edu_info.items():
            for j in m:#line
                ...
                for g in range(len(count_edu)):
                    education[str(g+1)]={'degree':'','universities':'','college&scholl':'','Gread&percentage':'','start_date':'','end_date':''}
        # print(education)
        for l,m in edu_info.items():
            for j in m:
                for degrees in degree_list:
                ...
                for college in college_list:
                    if college in j:
                        education[str(a)]['college&scholl']=college
                        # l1.append(universities)
                # a = re.findall("\d+\.\d+",j)
                # for i in a:
                #     if float(i)<=10.00:
                ...
                #     else:
                #         gread.append(str(i)+' %')
                #     education[str(a)]['Gread&percentage']==gread
                ...
                if re.findall('\d{2,4}',j.lower()):
                    ...
                    education[str(a)]['start_date']=aa[0]
                    education[str(a)]['end_date']=aa[1]
                    print(len(count_edu),a,j)
                    if  3>a:   
                        print('444444444444444444444444444444444444444444',education)
                        a+=1
                    else:
                        continue
        return education
